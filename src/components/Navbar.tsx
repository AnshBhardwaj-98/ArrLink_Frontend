  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        <Link 
          to="/" 
          className="text-2xl tracking-tighter text-on-surface font-display font-bold"
        >
          Aethernetics
        </Link>
        ...
        <div className="hidden md:flex items-center gap-12">
          ...
          <Link
            to="/contact"
            className="gradient-primary text-on-primary px-8 py-3 text-xs tracking-[0.1em] uppercase font-bold hover:opacity-90 transition-all duration-300 rounded-md"
          >
            Let's Talk
          </Link>
        </div>
