    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-20">
        <div className="max-w-sm">
          <Link
            to="/"
            className="text-2xl font-serif font-bold tracking-tight text-[#1A1A1A]"
          >
            Aethernetics
          </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 md:gap-24">
          <div className="flex flex-col gap-4">
            <span className="text-[10px] tracking-[0.3em] uppercase font-bold text-[#1A1A1A]">
              Company
            </span>
            <Link
              to="/about"
              className="text-sm text-[#666] hover:text-[#D4AF37] transition-colors font-sans"
            >
              About
            </Link>
            <Link
      ...
      <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-8">
          <Link
            to="/privacy"
            className="text-[11px] tracking-[0.1em] text-[#999] hover:text-[#1A1A1A] transition-colors uppercase font-medium"
          >
            Privacy
          </Link>
          <Link
