        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h1 className="text-4xl md:text-6xl text-[#1A1A1A] font-serif mb-6">
              Let's <span className="italic font-medium text-[#D4AF37]">Talk</span>
            </h1>
            ...
            {submitted ? (
              <div className="py-20 text-center animate-in fade-in zoom-in-95 duration-500">
                <div className="mb-6 inline-block p-4 bg-[#D4AF37]/10 rounded-full">
                  <div className="w-8 h-8 text-[#D4AF37] border-2 border-[#D4AF37] rounded-full flex items-center justify-center font-bold">✓</div>
                </div>
                <h2 className="text-2xl font-serif text-[#1A1A1A] mb-4">Inquiry Received</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <label className="text-[10px] tracking-[0.2em] uppercase font-bold text-[#1A1A1A] ml-1">Name</label>
                    <input
                      type="text"
                      required
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] tracking-[0.2em] uppercase font-bold text-[#1A1A1A] ml-1">Email Address</label>
                    <input
                      type="email"
                      required
                ...
                <div className="space-y-2">
                  <label className="text-[10px] tracking-[0.2em] uppercase font-bold text-[#1A1A1A] ml-1">Company</label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] tracking-[0.2em] uppercase font-bold text-[#1A1A1A] ml-1">Project Brief</label>
                  <textarea
                    required
                    rows={5}
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto bg-[#1A1A1A] text-white px-12 py-4 text-[10px] tracking-[0.2em] uppercase font-bold hover:bg-[#D4AF37] transition-all duration-500 rounded-full shadow-lg shadow-black/5"
                >
                  Submit Inquiry
                </button>
              </form>
          ...
          <div className="mt-24 pt-16 border-t border-gray-100 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
            <div>
              <p className="text-[10px] tracking-[0.3em] uppercase font-bold text-[#1A1A1A] mb-4">Email Us</p>
              <a href="mailto:info@aethernetics.co.in" className="text-sm font-light text-[#666] hover:text-[#D4AF37] transition-colors">
                info@aethernetics.co.in              </a>
            </div>
            <div>
              <p className="text-[10px] tracking-[0.3em] uppercase font-bold text-[#1A1A1A] mb-4">Availability</p>
              <p className="text-sm font-light text-[#666]">Mon — Fri, 9am — 6pm EST</p>
            </div>
            {/* <div>
